...
class Lead(Base):
    ...
    has_booking: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_chatbot: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_ecommerce: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_blog: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
