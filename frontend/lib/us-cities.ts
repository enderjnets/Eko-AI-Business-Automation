export const CITIES_BY_STATE: Record<string, string[]> = {
  ...
  Arizona: [
    ...
    "Gilbert", "Tempe", "Peoria", "Surprise", "Yuma", "Glendale", "Flagstaff",
  ],
  Arkansas: [
  ...
  Connecticut: [
    ...
    "Norwalk", "Danbury", "New Britain", "West Hartford", "Greenwich", "Bristol",
  ],
  Delaware: [
  ...
  Nebraska: [
    ...
    "Papillion", "La Vista", "Scottsbluff", "Beatrice", "South Sioux City",
  ],
  Nevada: [
  ...
  "New Hampshire": [
    ...
    "Laconia", "Lebanon", "Claremont", "Somersworth", "Londonderry",
  ],
  "New Jersey": [
  ...
  "New Mexico": [
    ...
    "Gallup", "Deming", "Los Lunas", "Sunland Park", "Las Vegas",
  ],
  "New York": [
  ...
  "North Carolina": [
    ...
    "Asheville", "Concord", "Gastonia", "Jacksonville", "Chapel Hill",
  ],
  "North Dakota": [
    "Fargo", "Bismarck", "Grand Forks", "Minot", "West Fargo",
    "Williston", "Dickinson", "Mandan", "Jamestown", "Wahpeton",
    "Devils Lake", "Valley City", "Grand Rapids", "Rugby", "Lincoln",
  ],
  Ohio: [
  ...
  Vermont: [
    ...
    "Winooski", "St. Albans", "Newport", "Vergennes", "Essex Junction",
    "Brattleboro", "Middlebury", "Bennington", "Williston", "Springfield",
  ],
  Virginia: [
  ...
  Wisconsin: [
    ...
    "West Allis", "La Crosse", "Sheboygan", "Wausau", "Fond du Lac",
  ],
  Wyoming: [
